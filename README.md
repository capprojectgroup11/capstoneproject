...
The main data preparation and analysis was done in Python using Pandas and implemented in the file:
...
After the Python process, I again used Excel briefly to:

Re-order columns

Rename final headers for clarity

Double-check for blank rows before Tableau import
